...
<head>
    ...
    <title>New Procure Request</title>
    <!--[if gte mso 9]>
    <xml>
                    ...
                    <tr>
                        <td style="padding: 20px 30px 40px 30px;">
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 20px; text-align: center;">
                                <tr>
                                    <td style="padding: 10px; !important; border: 1px solid #c3e6cb; text-align: center;">
                                        <!--[if gte mso 9]>
                                        ...
                                        <p style="margin: 0 0 20px 0; font-family: Arial, sans-serif; text-align: center;">You have a New Procure Request</p>
                                        <p style="margin: 0 0 20px 0; font-family: Arial, sans-serif; text-align: center;">Purchase Requst: {{ $prNo ?? ''}}</p>
                                        <!--[if gte mso 9]>
                                            </v:textbox>
                                        </v:rect>
                                        <![endif]-->
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto; text-align: center;">
                                <tr>
                                    <td style="border-radius: 4px; background: #155724; text-align: center;">
                                      <a href="{{env('APP_URL')}}" style="background: #155724; border: 15px solid #155724; font-family: Arial, sans-serif; font-size: 14px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 4px; font-weight: bold; color: #ffffff;">View</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
