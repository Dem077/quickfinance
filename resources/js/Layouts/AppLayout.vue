...
const filamentAdminUrl = computed(() => page.props.filamentAdminUrl);
    ...
    <div class="min-h-screen bg-canvas">
        ...
        >
            ...
            <div class="shrink-0 border-t border-sidebar-border p-3" :class="collapsed ? 'lg:p-2' : ''">
                ...
                <a
                    :href="filamentAdminUrl"
                    class="mt-2 flex w-full items-center justify-center rounded-xl border border-sidebar-border text-sm text-sidebar-muted transition hover:border-slate-300 hover:bg-sidebar-active hover:text-slate-900 dark:hover:border-slate-600 dark:hover:text-white"
                    :class="collapsed ? 'p-2.5 lg:px-0' : 'px-3 py-2'"
                >
                    <span :class="collapsed ? 'lg:hidden' : ''">Filament Admin</span>
                    <span :class="collapsed ? 'hidden text-xs lg:inline' : 'hidden'">FA</span>
                </a>
