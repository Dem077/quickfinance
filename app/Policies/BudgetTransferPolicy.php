...
class BudgetTransferPolicy
{
    ...
    {
        return $user->can('view_any_budget::transfer');
    }
    ...
    {
        return $user->can('view_budget::transfer');
    }
    ...
    {
        return $user->can('create_budget::transfer');
    }
    ...
    {
        return $user->can('update_budget::transfer');
    }
    ...
    {
        return $user->can('delete_budget::transfer');
    }
    ...
    {
        return $user->can('delete_any_budget::transfer');
    }
     ...
     */
    public function replicate(User $user, BudgetTransfer $budgetTransfer): bool
    {
